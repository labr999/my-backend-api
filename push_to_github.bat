...
git add -A
echo   [2/3] Committing V2.9.2 changes...
git commit -m "Update to V2.9.2: fix DPXQ crawler and expand to 20 pages 100 games"
...
if %ERRORLEVEL% equ 0 (
    ...
    echo   Render is now deploying V2.9.2 automatically.
